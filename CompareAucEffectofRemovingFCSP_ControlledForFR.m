...
xlim([0.6 3.2]);
set(gcf,'Render','Painter'); saveas(gcf,sprintf('Compare decreased FU AUC with removing FCSP-MemtoMem-%s-FRrange-%d-%dHz',Reg,FRrange(1),FRrange(2)),'fig'); close all;
% non-memory to memory
figure('position',[200 200 500 300]);
...
xlim([0.6 3.2]);
set(gcf,'Render','Painter'); saveas(gcf,sprintf('Compare decreased FU AUC with removing FCSP-NonmemtoMem-%s-FRrange-%d-%dHz',Reg,FRrange(1),FRrange(2)),'fig'); close all;
save(sprintf('Compare decreased FU AUC with removing FCSP-%s-FRrange-%d-%dHz',Reg,FRrange(1),FRrange(2)),'tbl_MemtoMem','tbl_NonmemtoMem','-v7.3');
