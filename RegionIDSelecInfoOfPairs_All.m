...
for bin = -1:1:5
    ...
    stats = [];
    load(['TestFC_XCORR_stats_' num2str(bin) '_' num2str(bin+BinSize) '_2msbin_' Group '.mat']);
    ...
    save(['FCofNeurons_PropertyPopulation_' num2str(bin) '_' num2str(bin+BinSize) '_' Group '.mat'],'Pair_reg','Pair_chain','Pref_pair','Pair_mouse',...
