...
for bin = 1:4
    ...
    save(sprintf('PairsFRModulation_nonsel_conn_chain_delay4s_%d_%d_%s.mat',bin,bin+1,Group),'FRPairChains_go','FRPairChains_nogo','FR_conn_Chains_go','FR_conn_Chains_nogo','FRModulPairChains_go','FRModulPairChains_nogo','FRModul_conn_chain_go','FRModul_conn_chain_nogo','-v7.3');
    ...
    save(sprintf('PairsFRModulation_selec_conn_chain_delay4s_%d_%d_%s.mat',bin,bin+1,Group),'FRPairChains_go','FRPairChains_nogo','FR_conn_Chains_go','FR_conn_Chains_nogo','FRModulPairChains_go','FRModulPairChains_nogo','FRModul_conn_chain_go','FRModul_conn_chain_nogo','-v7.3');
end
