...
for iTrial = 1:length(SpikeStampS1_Unit1)
    ...
    for iSpike = 1:length(SpikeStampS1_Unit1{iTrial})
        if ~isempty(find(SpikeStampS1_Unit2{iTrial}(:,1)-SpikeStampS1_Unit1{iTrial}(iSpike)<=0.005 & SpikeStampS1_Unit2{iTrial}(:,1)-SpikeStampS1_Unit1{iTrial}(iSpike)>0.002))
    ...
    for iSpike = 1:length(SpikeStampS1_Unit2{iTrial})
        if ~isempty(find(SpikeStampS1_Unit2{iTrial}(iSpike)-SpikeStampS1_Unit1{iTrial}(:,1)<=0.005 & SpikeStampS1_Unit2{iTrial}(iSpike)-SpikeStampS1_Unit1{iTrial}(:,1)>0.002))
...
for iTrial = 1:length(SpikeStampS2_Unit1)
    ...
    for iSpike = 1:length(SpikeStampS2_Unit1{iTrial})
        if ~isempty(find(SpikeStampS2_Unit2{iTrial}(:,1)-SpikeStampS2_Unit1{iTrial}(iSpike)<=0.005 & SpikeStampS2_Unit2{iTrial}(:,1)-SpikeStampS2_Unit1{iTrial}(iSpike)>0.002))
    ...
    for iSpike = 1:length(SpikeStampS2_Unit2{iTrial})
        if ~isempty(find(SpikeStampS2_Unit2{iTrial}(iSpike)-SpikeStampS2_Unit1{iTrial}(:,1)<=0.005 & SpikeStampS2_Unit2{iTrial}(iSpike)-SpikeStampS2_Unit1{iTrial}(:,1)>0.002))
