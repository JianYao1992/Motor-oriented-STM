...
set(gcf,'Renderer','Painter'); saveas(gcf,'Compare FC density between active and inactiveFC','fig'); close all;
save('Compare FC density between active and inactiveFC','tbl','-v7.3');
