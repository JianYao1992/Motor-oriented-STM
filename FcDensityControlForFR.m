...
saveas(gcf,sprintf('FC density-FR %d to %d Hz-TrialNumRange %d to %d-%s-%s-%s',TargetFR(1)-(TargetFR(2)-TargetFR(1))/2,TargetFR(end)+(TargetFR(2)-TargetFR(1))/2,...
    TrialNumRange(1),TrialNumRange(2),WhichTrials,region,Group),'fig');
close all;
save(sprintf('FC density-FR %d to %d Hz-TrialNumRange %d to %d-%s-%s-%s',TargetFR(1)-(TargetFR(2)-TargetFR(1))/2,TargetFR(end)+(TargetFR(2)-TargetFR(1))/2,...
