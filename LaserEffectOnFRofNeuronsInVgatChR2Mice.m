...
%% ID of neurons showing inhibited, activated, and unchanged modulation by laser
SuppressedUnitID = [];
ActivatedUnitID = [];
...
set(gcf,'Render','Painter'); saveas(gcf,'Distribution of responsive mPFC neurons','fig'); close all;
