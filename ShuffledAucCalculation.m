...
%% Step 1: Get the mean firing rate of all trials in two conditions when shuffled
...
if IsDVOrFRROC==1
    [ShuffledDV_S1,ShuffledDV_S2] = CalculateDV(ShuffledMeanFR_S1,ShuffledMeanFR_S2);
    %% Step 3: Calculate the TPR and FPR of single unit
    [TPR,FPR] = CalculateTPRFPRValue(ShuffledDV_S1,ShuffledDV_S2);
else
    [TPR,FPR] = CalculateTPRFPRValue(ShuffledMeanFR_S1',ShuffledMeanFR_S2');
end
%% Step 4: Calculate the Area under curve (AUC) of each unit
ShuffledAUC = CalculateAUCValue(FPR,TPR);
