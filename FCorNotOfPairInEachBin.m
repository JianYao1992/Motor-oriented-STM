...
for iBin = 1:1:numel(TarBinID)
    ...
    if to_save
        fprintf('%s_XCORR_stats_%d_%d_2msbin_%s.mat\n',prefix,bin_range(1),bin_range(2),Group);
        save(sprintf('%s_XCORR_stats_%d_%d_2msbin_%s.mat',prefix,bin_range(1),bin_range(2),Group),'stats','bin_range','-v7.3')
    end
end
